...
# Our main windows
niri msg action spawn -- kitty -d $"($nu.home-path)/dev/icub3d/advent-of-code" --title "recording-main-editor" -o font_size=18

# Our debug bar
niri msg action spawn -- kitty -d $"($nu.home-path)/dev/icub3d/advent-of-code" --title "recording-debug-bar" -o font_size=18
