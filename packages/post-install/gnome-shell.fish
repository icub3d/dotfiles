...
dconf write /org/gnome/shell/favorite-apps "['firefoxdeveloperedition.desktop', 'kitty.desktop', 'discord.desktop', 'virt-manager.desktop', 'org.gnome.Nautilus.desktop', 'net.lutris.Lutris.desktop', 'minecraft-launcher.desktop', 'steam-native.desktop']"
