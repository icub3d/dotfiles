...
dconf write /org/gnome/shell/favorite-apps "['firefox-developer-edition.desktop', 'kitty.desktop', 'org.gnome.Nautilus.desktop', 'virt-manager.desktop', 'net.lutris.Lutris.desktop', 'discord.desktop']"
